...
func (pa *PublishAcknowledgement) Decode(buf []byte) error {
	var err error
...
func (pa *PublishAcknowledgement) Encode(ver ProtocolVersion, buf *bytes.Buffer) error {
	var err error
...
func (pa *PublishAcknowledgement) Validate() RCode {
	return RCSuccess
}
